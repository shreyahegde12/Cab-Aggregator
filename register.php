...
<div class="d-flex align-items-center justify-content-center ">
  ...
  <div class="d-flex  justify-content-center align-items-center col-lg-7 bg-gradient-light text-dark">
    <div class="card card-outline card-purple w-75">
      ...
      <div class="card-body">
        <form id="register-frm" action="" method="post" onsubmit=checkPassword>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
                <input type="number" name="contact" id="contact" placeholder="Enter Contact" class="form-control form-control-sm form-control-border" pattern="(?=.*[0-9]){10, 10}" required>
          ...
          <div class="row">
            <div class="form-group col-md-6">
                <input type="email" name="email" id="email" placeholder="harryden@mail.com" class="form-control form-control-sm form-control-border" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2, 4}" required>
          ...
          <div class="row">
            <div class="form-group col-md-6">
                <div class="input-group">
                  <input type="password" name="password" id="password" placeholder="min length 6(only letters and numbers)" class="form-control form-control-sm form-control-border" minlength=6 pattern="(?=.*\d)(?=.*[a-z]).{6,15}" required>
            ...
            <div class="form-group col-md-6">
                <div class="input-group">
                  <input type="password" id="cpassword" placeholder="min length 6(only letters and numbers)" class="form-control form-control-sm form-control-border" minlength=6 pattern="(?=.*\d)(?=.*[a-z]).{6,15}" required>
                  <div class="input-group-append border-bottom border-top-0 border-left-0 border-right-0">
                    <span class="input-append-text text-sm"><i class="fa fa-eye-slash text-muted pass_type" data-type="password"></i></span>
                  </div>
                </div>
          ...
          <div id="error_pwd" style="display:none">Password doesn't contain </div>
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#register-frm').submit(function(e){
      ...
      if($('#password').val() == "")
            {
                document.getElementById("error_pickup").style.display = "block";
                e.preventDefault();
                return;
            }
